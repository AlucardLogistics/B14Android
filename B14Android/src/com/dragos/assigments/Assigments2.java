...
public static void main(String[] args) {
		...
		System.out.println("Return the index of the value " + value + 
				" in the sorted array or '-1' if element is not found: index = " + linearSearch(test, n, value));
		
		System.out.println("Binary Search:");
		System.out.println("Return the index of the value " + value + 
				" in the sorted array or '-1' if element is not found: index = " + binarySearch(test, value));
	 ...
	 */
	public static int linearSearch(int linear[], int n, int x) {
	 ...
	 * @return index of value
	 */
	public static int binarySearch(int binary[], int x) {
		//l = left most element
